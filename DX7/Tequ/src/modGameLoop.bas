...
Dim x As Long
    ...
    Do While Running = True
        ...
        If tmr250 < Tick Then
            ...
            Call frmMain.picMap.PaintPicture(frmMain.Picture1.picture, x, x, , , 5, 5, , , vbSrcAnd)
            ' Picture, Location to blt (x + y)
            ' width of the picture (x and y) IT COMPRESSES AND EXPANDS THE IMAGE
